      ...
      <div className="wrapper">
        ...
        <div className="content-wrap ">
          <section className="text-gray-600  body-font relative py-12">
            <div className="container box-shadow px-5 py-12 mx-auto flex flex-wrap">
              <h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800 pb-10">
                Contact Us
            </h1>
              <div className="lg:w-6/12 md:w-6/12 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
              ...
              <form onSubmit={submitContact} className="lg:w-5/12 md:w-5/12 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
