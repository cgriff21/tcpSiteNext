...
export default function Footer() {
  ...
  return (
    <footer className="text-gray-600 body-font bg-gray-100 bottom">
          ...
          <div className="lg:w-1/3 md:w-1/3 w-full px-4">
            ...
            <form onSubmit={addToNewsletter} className="space-y-5">
              <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-nowrap flex-wrap justify-center pb-5 items-end md:justify-start">
                ...
                <button type='submit' className="mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-TCPpurple-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Submit</button>
              </div>
            </form>
            {showAlert ? (
